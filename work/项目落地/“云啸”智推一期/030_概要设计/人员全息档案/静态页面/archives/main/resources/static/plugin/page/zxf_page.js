		...
		addhtml:function(obj,pageinit){
			return (function(){
				...
				if (pageinit.current > 1) {
					obj.append('<a href="javascript:;" class="prebtn"><i class="fa fa-arrow-left"></i></a>');
				} else{
					obj.remove('.prevPage');
					obj.append('<span class="disabled"><i class="fa fa-arrow-left"></i></span>');
				}
				/*中间页*/
				...
				if (pageinit.current >= pageinit.pageNum) {
					obj.remove('.nextbtn');
					obj.append('<span class="disabled"><i class="fa fa-arrow-right"></i></span>');
				} else{
					obj.append('<a href="javascript:;" class="nextbtn"><i class="fa fa-arrow-right"></i></a>');
				}
				/*尾部*/
				obj.append('<span style="padding:0;">'+'共'+'<b>'+pageinit.pageNum+'</b>'+'页，'+'</span>');
                obj.append('<span style="padding:0;">'+'共'+'<b>'+pageinit.totalNum+'</b>'+'条，'+'</span>');
				obj.append('<span style="padding:0;">'+'跳至'+'<input type="text" class="zxfinput" value="'+pageinit.current+'"/>'+'页'+'</span>');
				obj.append('<span style="padding:0;" class="zxfokbtn">'+'确定'+'</span>');
			}());
		},
