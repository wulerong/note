...
function SelectableTableRows(oElement, bMultiple) {
	if (oElement == null)
		return;
...
SelectableTableRows.prototype.setItemSelected = function (oEl, bSelected) {
	if (!this._multiple) {
		if (bSelected) {
...
SelectableTableRows.prototype.setItemSelectedUi = function (oEl, bSelected) {
	if (bSelected)
...
SelectableTableRows.prototype.getItemSelected = function (oEl) {
	return Boolean(oEl._selected);
};

SelectableTableRows.prototype.fireChange = function () {
	if (!this._fireChange)
		return;
...
SelectableTableRows.prototype.click = function (e) {
...
SelectableTableRows.prototype.getSelectedItems = function () {
	//clone
	var items = this._selectedItems;
	var l = items.length;
	var tmp = new Array(l);
...
SelectableTableRows.prototype.destroy = function () {
...
SelectableTableRows.prototype.getNext = function (el) {
...
SelectableTableRows.prototype.getPrevious = function (el) {
...
SelectableTableRows.prototype.isBefore = function (n1, n2) {
...
SelectableTableRows.prototype.getItem = function (nIndex) {
	var j = 0;
	var cs = this._htmlElement.childNodes;
	var l = cs.length;
	for (var i = 0; i < l; i++) {
...
SelectableTableRows.prototype.getSelectedIndexes = function () {
